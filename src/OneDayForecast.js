...
export const OneDayForecast = ({ day }) => {
  ...
  //Gauna šios dienos stringą, kurį paskui palygina su h4 verte
  var month = new Date().getMonth() + 1;
  var date = new Date().getDate();
  if (date.toString().length === 1) {
    var today = "0" + month.toString() + "-0" + date.toString();
    }
    else {
      today = "0" + month.toString() + "-" + date.toString();
    }

  return (
  <div className="one-day" >
    <h4>{day[0]["date"].slice(5) === today ? "Today" : day[0]["date"].slice(5)}</h4>
    <div className="max-min">
        <p className="max">{day[1]["maxTemp"]} °C</p>
        <p>{day[2]["minTemp"]} °C</p>
    </div>
    <img src={"https://developer.foreca.com/static/images/symbols/" + day[3]["symbol"] + ".png"}
        alt="Weather symbol" />
    <div className="rain">
      <svg stroke="currentColor" fill="blue" strokeWidth="0" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="8 6 15 15" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M11.01,12.23c0-0.26,0.13-0.59,0.38-1.01c0.25-0.42,0.5-0.77,0.73-1.04c0.06-0.07,0.14-0.17,0.23-0.28s0.15-0.17,0.16-0.18
        ...
        c-0.29,0-0.53-0.09-0.72-0.28C15.75,9.98,15.65,9.75,15.65,9.48z"></path></svg>
