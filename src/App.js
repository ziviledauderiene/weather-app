...
// šitas gabalas užkrauna Vilniaus duomenis pradiniam puslapiui. Jis užkraunamas tik vieną kartą(užkraunant puslapį), nes jo dependency array yra tuščias.
useEffect (() => {
  (async ()=>{
    const response = 
      await fetch("https://foreca-weather.p.rapidapi.com/current/100593116?tempunit=C&windunit=MS&lang=en", {
        "method": "GET",
        "headers": {
  ...
  (async ()=>{
    const response = 
      await fetch("https://foreca-weather.p.rapidapi.com/forecast/daily/100593116?alt=0&tempunit=C&windunit=MS&periods=8&dataset=full", {
        "method": "GET",
        "headers": {
          "x-rapidapi-host": "foreca-weather.p.rapidapi.com",
          "x-rapidapi-key": "047e2c187bmsh433b21ef75b8c98p1b944ajsncdd12618e935"
...
<div className="container">
  ...
  // onClick={getPrevWeather}
  >Back to {prevCity.current} weather
  </button> */}
